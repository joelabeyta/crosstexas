...
}f=f.removeAttr("id").hide().prev().attr("id",g).show()}f.addClass("placeholder"),f[0].value=f.attr("placeholder")}else f.removeClass("placeholder")}var g,h,i="placeholder"in b.createElement("input"),j="placeholder"in b.createElement("textarea"),k=c.fn,l=c.valHooks;i&&j?(h=k.placeholder=function(){return this},h.input=h.textarea=!0):(h=k.placeholder=function(){var a=this;return a.filter((i?"textarea":":input")+"[placeholder]").not(".placeholder").bind({"focus.placeholder":e,"blur.placeholder":f}).data("placeholder-enabled",!0).trigger("blur.placeholder"),a},h.input=i,h.textarea=j,g={get:function(a){var b=c(a);return b.data("placeholder-enabled")&&b.hasClass("placeholder")?"":a.value},set:function(a,d){var g=c(a);return g.data("placeholder-enabled")?(""==d?(a.value=d,a!=b.activeElement&&f.call(a)):g.hasClass("placeholder")?e.call(a,!0,d)||(a.value=d):a.value=d,g):a.value=d}},i||(l.input=g),j||(l.textarea=g),c(function(){c(b).delegate("form","submit.placeholder",function(){var a=c(".placeholder",this).each(e);setTimeout(function(){a.each(f)},10)})}),c(a).bind("beforeunload.placeholder",function(){c(".placeholder").each(function(){this.value=""})}))}(this,document,jQuery),jQuery(document).ready(function(a){function b(){var b=a("header").find("img.header-image").attr("src");a("header").find("img.header-image").hide(),a("header").css({"background-image":"url("+b+")"})}function c(){a.cookie("cw_lic","0",{expires:1,path:"/"});var b,c,d="admin",e="admin",f=a("#user_name").val(),g=a("#user_pass").val();b=f==d?1:0,c=g==e?1:0,1===b&&1===c?a.cookie("cw_lic","1",{expires:1,path:"/"}):a.cookie("cw_lic","2",{expires:1,path:"/"})}function d(){var b=a(".cw-tabs-list").outerHeight()+65,c=a(".tab-open").outerHeight()+b;a(".cw-tabs-container").stop().animate({height:c+"px"},250)}a("html").hasClass("lt-ie9")||(a(document).foundation(),console.log("Foundation Js loaded"));var e;a(".scrollto").click(function(){var b=a(this).data("target");a("html, body").animate({scrollTop:a("#"+b).offset().top-100},750)}),a(".cwa-section-header").click(function(){a(this).hasClass("open-header")?a(this).hasClass("open-header")&&a(this).removeClass("open-header"):(a(".open-header").removeClass("open-header"),a(this).addClass("open-header")),a(".cwa-section-content").slideUp(400).removeClass("open-tab"),a(this).next(".cwa-section-content").is(":visible")?a(this).next(".cwa-section-content").slideUp(400).removeClass("open-tab"):a(this).next(".cwa-section-content").slideDown(400).addClass("open-tab")}),a(".cw-tabs").click(function(){var b=a(this).data("tab");a(".tab-active").removeClass("tab-active"),a(this).addClass("tab-active"),a(".tab-open").removeClass("tab-open"),a("#"+b).addClass("tab-open"),d()}),a(".logout-button").click(function(){a.cookie("cw_lic","3",{expires:1,path:"/"}),window.location="/login.html"}),e=a("form.login-form").find('input[type="submit"]'),e.click(function(){c()}),setTimeout(function(){a(".warning").slideUp()},1e4),a(window).load(function(){d(),b()}),a(window).resize(function(){d()})});
